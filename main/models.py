...
class ProductVariant(models.Model):
    ...
    size_uz = models.CharField(_("O'lcham (O'zbek)"), max_length=10, null=True, blank=True)
    size_ru = models.CharField(_("Размер (Русский)"), max_length=10, null=True, blank=True)
    size_en = models.CharField(_("Size (English)"), max_length=10, null=True, blank=True)
