...
class Product(models.Model):
    ...
    units_id = models.CharField(_("o'lchov birligi raqami"), max_length=100, default=1377058)
...
class ProductVariant(models.Model):
    ...
    size_uz = models.CharField(_("O'lcham (O'zbek)"), max_length=20, null=True, blank=True)
    size_ru = models.CharField(_("Размер (Русский)"), max_length=20, null=True, blank=True)
    size_en = models.CharField(_("Size (English)"), max_length=20, null=True, blank=True)
